...
contract CandyToken is ERC20, IERC721Receiver {
    ...
    uint256 public contractAmountToSwap = 1 ether;

    uint256 public devmarketingFeeOnBuy = 5;
    uint256 public liquidityFeeOnBuy = 3;
    uint256 public totalFeesOnBuy = 8;
    uint256 public devmarketingFeeOnSell = 5;
    uint256 public liquidityFeeOnSell = 3;
    uint256 public totalFeesOnSell = 8;
    uint256 public burnTaxOnSell = 2;
    uint256 public burnTaxOnBuy = 2;
    ...
    function _transfer(
        ...
        if (SwapAndLiquifyEnabled) {
            ...
            if (canSwap && !swapping && !automatedMarketMakerPools[from] && !automatedMarketMakerPools[to]) {
                swapping = true;
    ...
    function swapTokens(uint256 tokenAmount) private {
        ...
        uint256 swappedNative = weth.balanceOf(address(this));
